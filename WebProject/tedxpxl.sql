...
--
-- Machine: 127.0.0.1
-- Gegenereerd op: 21 mei 2015 om 22:20
-- Serverversie: 5.6.17
-- PHP-versie: 5.5.12
...
INSERT INTO `posts` (`berichtID`, `topicID`, `gebruikerID`, `bericht`, `postDate`) VALUES
...
INSERT INTO `threads` (`topicID`, `titel`, `bericht`, `gebruikerID`) VALUES
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `al_ingelogd` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Deze kolom geeft aan of het de 1e keer is dat een gebruiker inlogt: 0 = nog niet ingelogd, 1 = al eens ingelogd',
...
INSERT INTO `users` (`gebruikerID`, `rolID`, `loginNaam`, `nickName`, `wachtwoord`, `salt`, `voorNaam`, `familieNaam`, `email`, `profielfoto`, `al_ingelogd`) VALUES
