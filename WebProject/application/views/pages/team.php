                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-login-box animated fadeInUp">
                                <form role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <p>Don't have an account! <a href="login-register">Register Now</a></p>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 margin20">
                    <h3 class="heading">Little About our team</h3>
                    <p>
                    ...
                    <p><a href="#" class="btn btn-theme-bg">Read more</a></p>
                </div>
                <div class="col-md-6">
                    <img src="img/teamImg/team.jpg" class="img-responsive" alt="">
                </div>
            </div><!--about intro-->
            ...
            <div class="row">
                <div class="col-md-4 margin20">
                    <div class="team-wrap">
                        <img src="img/teamImg/jarno.jpg" class="img-responsive" alt="">
                        <h4>Jarno Michiels</h4>
                ...
                <div class="col-md-4 margin20">
                    <div class="team-wrap">
                        <img src="img/teamImg/stef.jpg" class="img-responsive" alt="">
                        <h4>Stef Janssens</h4>
                        <span>Web Designer</span>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel, eleifend sed turpis
                ...
                <div class="col-md-4 margin20">
                    <div class="team-wrap">
                        <img src="img/teamImg/koen.jpg" class="img-responsive" alt="">
                        <h4>Koen Vaes</h4>
                        <span>Web Designer</span>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel, eleifend sed turpis
            ...
            <div class="row">
                <div class="col-md-4 margin20">
                    <div class="team-wrap">
                        <img src="img/teamImg/piet.jpg" class="img-responsive" alt="">
                        <h4>Piet Vandeput</h4>
                        <span>Web Designer</span>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel, eleifend sed turpis
                ...
                <div class="col-md-4 margin20">
                    <div class="team-wrap">
                        <img src="img/teamImg/frederik.jpg" class="img-responsive" alt="">
                        <h4>Frederik Thuysbaert</h4>
                        <span>Web Designer</span>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel, eleifend sed turpis
                        </p>
