                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active">
                            ...
                            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                ...
                                <li><a href="<?php echo base_url(); ?>admin/gebruikerOverzicht">Gebruikers (5)</a></li><!-- de 5 is het aantal users dat nog niet geactiveerd is, laat dit in mooie opmaak zien en niet gwn tss haakjes?-->
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <table class="table table-striped table-bordered"> <tr> <th> RolID </th> <th> Username: </th> <th> E-mail: </th> <th> Voornaam: </th> <th> Familienaam: </th> </tr>
                        ...
                        <tr><td>{rolID}</td> <td>{username}</td> <td>{email}</td> <td>{voornaam}</td> <td>{familienaam}</td>
                            <td> <a href="gebruikers/verwijderen_gebruiker?id={gebruikerID}" onclick="return confirm('Weet u zeker dat u deze gebruiker wil verwijderen?')"></i>verwijderen</a></td>
                            <td> <a href="gebruikers/bewerken_gebruiker?id={gebruikerID}">bewerken</a></td>
                            {/gebruikers}
                        </tr> 
                    </table>
