...
--
-- Machine: localhost
-- Genereertijd: 28 apr 2015 om 20:48
...
INSERT INTO `gebruikers` (`gebruikerID`, `rolID`, `loginNaam`, `nickName`, `wachtwoord`, `salt`, `voorNaam`, `familieNaam`, `email`, `profielfoto`, `al_ingelogd`) VALUES
...
--
-- Tabelstructuur voor tabel `temp_gebuikers`
--

CREATE TABLE IF NOT EXISTS `temp_gebuikers` (
  `tempID` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(255) NOT NULL,
  `loginNaam` varchar(75) NOT NULL,
  PRIMARY KEY (`tempID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
