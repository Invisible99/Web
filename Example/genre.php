...
<div class="container">
  ...
  <div class="content">
   <?php		
	...
	?>
<div id="menu"> 
          <a href="?id=1" style="text-decoration:none;">Action</a>-
          <a href="?id=2" style="text-decoration:none;">Adventure</a>-
          <a href="?id=3" style="text-decoration:none;">Compilation</a>-
          <a href="?id=4" style="text-decoration:none;">Educational</a>-
          <a href="?id=5" style="text-decoration:none;">Fighting</a>-
          <a href="?id=6" style="text-decoration:none;">Home</a>-
          <a href="?id=7" style="text-decoration:none;">Puzzle</a>-
          <a href="?id=8" style="text-decoration:none;">Racing</a>
          <br />
          <br />
          <a href="?id=9" style="text-decoration:none;">Role-Playing</a>-
          <a href="?id=10" style="text-decoration:none;">Shooter</a>-
          <a href="?id=11" style="text-decoration:none;">Simulation</a>-
          <a href="?id=12" style="text-decoration:none;">Sports</a>-
          <a href="?id=13" style="text-decoration:none;">Strategy</a>-
          <a href="?id=14" style="text-decoration:none;">Traditional</a>-
          <a href="?id=15" style="text-decoration:none;">Unknown</a>-
          <a href="?id=16" style="text-decoration:none;">X/Adult</a>
</div>
<br />
<br />
<br />
		...
		if (isset($_GET['id']))
		{
            ...
            <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                ...
                <li class="TabbedPanelsTab" tabindex="0">Genre Info</li>
              </ul>
			...
			echo "<br />
			<div id='menu'>
					<a href='genre.php?id=".$id."&page=prev&teller1=".$teller1."&teller2=".$teller2."' style='text-decoration:none; float:left; margin-left:12.5%; color:#000'>PREV</a>
					<a href='genre.php?id=".$id."&page=next&teller1=".$teller1."&teller2=".$teller2."' style='text-decoration:none; float:right; margin-right:12.5%; color:#000'>NEXT</a>
			</div>
			<br />
			<br />";		
			$sql = "SELECT * FROM tblgames WHERE Genre_ID = '$id' ORDER BY Title LIMIT $teller1, $teller2";
	...
	?>
    		<table style='background-color: #000000; color: #ff0000; margin-left:12.5%; margin-right:12.5%;' width="75%">
            	<tr>
                	<td width="10%" style="font-size:12px">Release Date</td>
                    <td width="50%" style="font-size:12px">Title</td>
                    <td width="15%" style="font-size:12px">Platform</td>
                </tr>
            </table>    
    <?php
			...
			{
	?>
    	<table style='background-color: #ff0000; color: #000000; margin-left:12.5%; margin-right:12.5%;' width="75%">
			<tr>
                <td width="10%" style="font-size:10px"><?php echo $row['Release Date']; ?></td>
                <td width="50%" style="font-size:10px"><?php echo $row['Title']; ?></td>
                <td width="15%" style="font-size:10px"><?php echo $row['Platform']; ?></td>
            </tr>    
        </table>
    <?php
			}	
