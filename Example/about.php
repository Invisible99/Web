...
<div class="container">
  ...
  <div class="content">
   <?php		
	...
	?>
	<table width="50%" height="90%" style="margin-left:15%; margin-right:25%; margin-top:5%">
    	<tr>
        	<td width="150px" height="150px"><img src="sharingan.jpg" width="150px" height="150px"/></td>
            <td><p style="text-align:5%">Surname: Michiels<br />Firstname: Jarno<br />Address: Unkown<br />E-mail: waffel1995@gmail.com</p></td>
        </tr>
    </table>
</div>
  <div class="sidebar2">
