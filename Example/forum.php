...
<div class="container">
  ...
  <div class="content">
   <?php		
	...
	$user = 'root';
	$password = 'dreft321';
	$link=mysql_connect($host,$user,$password) OR die("connectie met server mislukt");
    mysql_select_db('dbforum',$link) OR die("connectie met databank mislukt");
	$sql = "SELECT * FROM categories ORDER BY category_title ASC";
	$res = mysql_query ($sql, $link) or die ("Query fout");
	$categories = "";
	echo "<h6 style='margin-left:5%'><a href ='javascript:void(0);' onClick=window.open('create_category.php','','width=700,height=250')>Create Category</a></h6>";
